...
def main():
    ...
    original_dataset_size = 24553
    trained_dataset_size = 24553

    # Paso 2: Dividir los datos en características (X) y etiquetas (y)
    # Columns gender,age,PainGrade,BlooddpressurSystol,BlooddpressurDiastol,PulseRate,RespiratoryRate,O2Saturation,AVPU
    # Target column TriageGrade
